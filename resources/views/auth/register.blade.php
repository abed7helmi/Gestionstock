    ...
    <body>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header bg-dark text-white">{{ __("S'ENREGISTRER") }}
                            <div class="row justify-content-md-center"><img src="{{ asset('assets/img/logo.svg.png')}}" width="80" height="60"></div></div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="custom-select mr-sm-2" name="statut">
                                            ...
                                            <option value="interne" selected value="">Interne</option>
